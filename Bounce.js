...
alert("Hi the canvas bounds are width " + canvasWidth + ", " + canvasHeight);

var colorList = ["#ccffcc", "##7fffd4", "#99ddff", "#cc3399", 
"#ff6699", "#ffccff", "#cc99ff","	#e0ffff"];
...
//console.log ("totalColors is " + totalColors);
...
function redraw(){
	...
	for(var i=0; i < xCoordList.length; i++) {
		...
		context.beginPath();
			...
			console.log(" whatColorNumber is " + whatColorNumber);

			var myColor = colorList[whatColorNumber];
